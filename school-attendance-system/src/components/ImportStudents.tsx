...
export default function ImportStudents() {
 ...
 const studentsData = {
  ...
  'Falcone-4AX': [
    'Chiaro Carlo', 'Cianciulli Francesco', 'Ciniglio Raffaele', 'Coccia Antonio Pio', 'D\'Alterio Francesco Pio', 'D\'Oriano Mattia', 'Daniele Francesco Pio', 'De Falco Gennaro', 'De Rosa Luca', 'De Vivo Carlo', 'Di Costanzo Nicola', 'Gallo Antonio Pio', 'Licciardi Giovanni', 'Lucignano Alessandro', 'Margiore Carlo', 'Oterbo Danilo', 'Scotti Covella Antonio'
  ],
  'Pitagora-4C': [
  ...
  'Pitagora-4ASA': [
    'Cecaro Alexandro', 'Ciotola Rebecca', 'D\'Isanto Alessandro', 'Esposito Tommaso', 'Forte Marika', 'Gisonna Giulia', 'La Motta Daniele', 'Lanuto Arianna', 'Lauro Elsa', 'Lemma Carolina', 'Lubrano Lavadera Lavinia', 'Manna Lorenzo', 'Massa Eleonora', 'Mazzella Di Cecaro Daniele', 'Merone Carmen', 'Musiello Ilaria', 'Nuziale Aldo', 'Riso Lorenzo', 'Romano Sara', 'Scamardella Jacopo', 'Scotto Di Carlo Andrea'
  ],
  'Pitagora-4FSA': [
