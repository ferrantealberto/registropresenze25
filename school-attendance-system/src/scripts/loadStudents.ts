...
const students = [
  ...
  { name: 'Alessandro Rossi', class: '4A', school: 'Pitagora' },
  { name: 'Marco Bianchi', class: '4A', school: 'Pitagora' },
  { name: 'Giuseppe Verdi', class: '4A', school: 'Pitagora' },
  { name: 'Francesca Romano', class: '4A', school: 'Pitagora' },
  { name: 'Laura Conti', class: '4A', school: 'Pitagora' },
  { name: 'Andrea Moretti', class: '4A', school: 'Pitagora' },
  { name: 'Sofia Ricci', class: '4A', school: 'Pitagora' },
  { name: 'Luca Ferrari', class: '4A', school: 'Pitagora' },
  { name: 'Elena Costa', class: '4A', school: 'Pitagora' },
  { name: 'Davide Marino', class: '4A', school: 'Pitagora' },
  { name: 'Chiara Greco', class: '4A', school: 'Pitagora' },
  { name: 'Matteo Bruno', class: '4A', school: 'Pitagora' },
  { name: 'Valentina Leone', class: '4A', school: 'Pitagora' },
  { name: 'Roberto Galli', class: '4A', school: 'Pitagora' },
  { name: 'Martina Serra', class: '4A', school: 'Pitagora' },
];
